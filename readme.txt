...
2. Method availability support, select in which countries this method is available.
3. Support debug log.
4. Form submission method includes posting via a form or using a redirect/querystring.
5. Support English and Chinese languages.
